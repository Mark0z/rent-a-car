    ...
    <header>
      ...
      <div className="contact">
        <div className="contact-info">
          <p className="contact-info--p__title">RentDrive</p>
          <p className="contact-info--p">ul. Równa 13</p>
          <p className="contact-info--p">80-067 Gdańsk</p>
          <p className="contact-info--p contact-info--p__small">PON - SOB 7 - 23</p>
          <p className="contact-info--p contact-info--p__small">NDZ 6 - 24</p>
        </div>
