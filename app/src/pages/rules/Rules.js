  ...
  return (
    <div className="rules">
      <Content className="rules-content">
        <ContentBox className="rules--content-box" title="Zasady najmu">
          <ul>
            <li>
              <h3 className="rules--h3">Dokumenty wymagane do najmu</h3>
              <p className="rules--p">
            ...
            <li>
              <h3 className="rules--h3">Minimalny wiek najemcy</h3>
              <p className="rules--p">
            ...
            <li>
              <h3 className="rules--h3">Kaucja</h3>
              <p className="rules--p">
            ...
            <li>
              <h3 className="rules--h3">Czas trwania najmu</h3>
              <p className="rules--p">
            ...
            <li>
              <h3 className="rules--h3">Stan techniczny pojazdu</h3>
              <p className="rules--p">
            ...
            <li>
              <h3 className="rules--h3">Zakres użytkowania</h3>
              <p className="rules--p">
            ...
            <li>
              <h3 className="rules--h3">Ubezpieczenie</h3>
              <p className="rules--p">
            ...
            <li>
              <h3 className="rules--h3">Zwrot pojazdu</h3>
              <p className="rules--p">
